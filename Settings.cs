...
namespace ForceOffline {
    public class Settings {
        ...
        public Settings() {
            ...
            ReportOnline = ForceOffline.conf.Bind("", "ReportOnline", false, new ConfigDescription("When this is disabled, offline runs are kept separately in a way that they won't be reported" +
